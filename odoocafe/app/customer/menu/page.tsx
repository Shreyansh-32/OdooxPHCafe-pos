...
export default function CustomerMenuPage() {
  ...
  if (loading) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: s.bg, color: s.muted }}>
  ...
  return (
    <div style={{ minHeight: "100vh", background: s.bg, color: s.text, fontFamily: "inherit" }}>
      {/* Header */}
      <div
        style={{
          position: "sticky",
      ...
      >
        <div>
          <div style={{ fontSize: "16px", fontWeight: "700", color: s.text }}>☕ Café Odoo</div>
          ...
          <div style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "12px", paddingBottom: "120px" }}>
            {filteredProducts.map((product) => {
              ...
              return (
                ...
                >
                  <div style={{ flex: 1 }}>
                    <div style={{ fontSize: "11px", color: product.category.color, fontWeight: "700", marginBottom: "2px" }}>
                    ...
                    {product.description && (
                      <div style={{ fontSize: "12px", color: s.muted }}>{product.description}</div>
                    )}
                    <div style={{ fontSize: "16px", fontWeight: "800", color: s.primary, marginTop: "6px" }}>
                    ...
                    {inCart ? (
                      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                        <button
                          ...
                          style={{
                            ...
                            background: s.border, color: s.text, padding: 0,
                        ...
                        <button
                          ...
                          style={{
                            width: "30px", height: "30px", borderRadius: "8px",
                            background: s.primary, color: "#fff", padding: 0,
                            display: "flex", alignItems: "center", justifyContent: "center",
                            border: "none", cursor: "pointer",
                          }}
                        >
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: `1px solid ${s.primary}44`, padding: 0,
                          display: "flex", alignItems: "center", justifyContent: "center",
                          cursor: "pointer",
                        }}
                      >
      ...
      {view === "profile" && customer && (
        <div style={{ padding: "20px 16px", maxWidth: "500px", margin: "0 auto", paddingBottom: "120px" }}>
          <div style={{ background: s.card, border: `1px solid ${s.border}`, borderRadius: "14px", padding: "20px", marginBottom: "24px", textAlign: "center" }}>
            <div style={{ width: "60px", height: "60px", borderRadius: "50%", background: `${s.primary}22`, color: s.primary, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "24px", fontWeight: "700", margin: "0 auto 12px" }}>
              {customer.name.charAt(0).toUpperCase()}
            </div>
            <h2 style={{ margin: "0 0 4px", fontSize: "20px", fontWeight: "800" }}>{customer.name}</h2>
            <p style={{ margin: "0 0 16px", fontSize: "14px", color: s.muted }}>{customer.email}</p>
            <button
          ...
          {historyLoading ? (
            <div style={{ textAlign: "center", padding: "40px", color: s.muted }}>Loading history...</div>
          ) : orderHistory.length === 0 ? (
            <div style={{ textAlign: "center", padding: "40px", color: s.muted, background: s.card, borderRadius: "14px", border: `1px solid ${s.border}` }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              {orderHistory.map((order) => {
                ...
                return (
                  <div key={order.id} style={{ background: s.card, border: `1px solid ${s.border}`, borderRadius: "14px", padding: "16px", opacity: isCancelled ? 0.7 : 1 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "12px" }}>
                      <div>
                        <div style={{ fontSize: "15px", fontWeight: "700", color: s.primary }}>Order #{order.orderNumber}</div>
                        <div style={{ fontSize: "12px", color: s.muted }}>
                    ...
                    {order.table && (
                      <div style={{ fontSize: "12px", color: s.text, marginBottom: "8px", background: "rgba(255,255,255,0.05)", padding: "4px 8px", borderRadius: "4px", display: "inline-block" }}>
                        📍 {order.table.floor.name} - Table {order.table.tableNumber}
                      </div>
                    )}

                    <div style={{ fontSize: "13px", color: s.muted, display: "flex", flexDirection: "column", gap: "4px" }}>
