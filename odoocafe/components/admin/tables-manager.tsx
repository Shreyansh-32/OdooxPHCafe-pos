        ...
        {floors.map((f) => (
          <button
            ...
            style={{
              ...
              fontSize: "13px",
              fontWeight: "600",
              background: selectedFloor === f.id ? "rgba(200,121,65,0.15)" : "var(--color-bg-overlay)",
              color: selectedFloor === f.id ? "#c87941" : "var(--color-text-muted)",
              border: `1px solid ${selectedFloor === f.id ? "#c8794144" : "var(--color-border)"}`,
            }}
          >
            {f.name}
          </button>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                    <div>
                      <div style={{ fontSize: "20px", fontWeight: "800", color: "#c87941" }}>
                        {table.tableNumber}
                      </div>
          ...
          <div style={{ background: "var(--color-bg-elevated)", border: "1px solid var(--color-border)", borderRadius: "16px", padding: "28px", maxWidth: "400px", width: "100%", animation: "fadeIn 0.2s ease" }}>
            ...
            <form onSubmit={addTable} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                ...
                <button id="add-table-submit" type="submit" style={{ flex: 1, background: "linear-gradient(135deg, #c87941, #a06030)", color: "#fff", padding: "11px", justifyContent: "center", fontWeight: "600" }}>Add Table</button>
              </div>
            </form>
          </div>
        </div>
