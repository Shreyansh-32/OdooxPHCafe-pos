...
import { X, Banknote, QrCode, CreditCard, CheckCircle2, Loader2 } from "lucide-react";
...
export function PaymentDialog({
  ...
  // Load payment methods + Razorpay script
  useEffect(() => {
      ...
      >
        ...
        >
          <div>
            ...
            <div
              style={{ fontSize: "26px", fontWeight: "800", color: sv.primary }}
            >
          ...
          {tab === "cash" && (
            <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              ...
              >
                ...
                {loading ? "Processing..." : "Confirm Cash Payment & Send to Kitchen"}
              </button>
            </div>
          )}
          ...
          {tab === "upi" && (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px", alignItems: "center" }}>
              ...
              >
                ...
                {loading ? "Processing..." : "Payment Received — Send to Kitchen"}
              </button>
            </div>
          )}
          ...
          {tab === "razorpay" && (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              >
                ...
                <div
                  style={{ fontSize: "13px", color: sv.muted, lineHeight: "1.5" }}
                >
