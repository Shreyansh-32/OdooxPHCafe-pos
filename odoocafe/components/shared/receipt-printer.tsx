          ...
          <div style={{ padding: "20px" }}>
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <span style={{ fontWeight: "700", color: "#166534" }}>{paymentMethod}</span>
              </div>
            </div>
            ...
            <div style={{ marginBottom: "12px" }}>
              ...
              {items.map((item, i) => (
                ...
                >
                  ...
                  <span style={{ textAlign: "right" }}>₹{item.lineTotal.toFixed(2)}</span>
                </div>
              ))}
            </div>

            {/* Totals */}
            <div style={{ borderTop: "1px dashed #ddd", paddingTop: "12px", fontSize: "13px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "4px", color: sv.muted }}>
                <span>Subtotal</span>
